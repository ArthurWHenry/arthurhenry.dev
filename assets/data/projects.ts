export const projects = [
  ...
  },
  {
    name: "Streats",
    description:
      "Web application that helps locals find food trucks near them.",
    link: "https://www.gostreats.com/",
    altText: "Streats - Where Food Meets.",
  },
  {
    name: "localhand",
    description:
      "Application built during hackathon to get small businesses to engage with their local community and vice versa.",
